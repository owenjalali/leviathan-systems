...
export const pillars = [
  {
    ...
    description:
      'We identify where your operation breaks down. Slow responses, missed steps, manual handoffs. Then we build a system that handles it automatically. The bottleneck gets replaced with a process that runs on its own.',
