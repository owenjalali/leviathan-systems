  ...
  return (
    <div className="bg-[var(--bg-primary)] min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
      ...
      <div className="text-center relative z-10 px-6">
        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-semibold text-[var(--text-primary)] mb-6 transition-all duration-1000 opacity-100 translate-y-0">
          Coming Soon
        </h1>
        <p className="text-xl text-[var(--text-muted)] transition-all duration-1000 delay-200 opacity-100 translate-y-0">
