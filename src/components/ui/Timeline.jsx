      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
          ...
          >
            ...
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-[var(--bg-primary)] flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-[var(--bg-elevated)] border border-[var(--border)] p-2" />
              </div>
              <h3 className="hidden md:block text-xl md:pl-20 md:text-4xl font-bold text-[var(--text-muted)]">
                {item.title}
              </h3>
            </div>
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-full bg-gradient-to-t from-[var(--accent)] via-[var(--accent)] to-transparent rounded-full"
          />
        </div>
      </div>
    </div>
